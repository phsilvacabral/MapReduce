...
public class LargestSmallestTransactionInBrazil {
    ...
    public static void main(String args[]) throws IOException,
        ...
        Path output = new Path("output/question6");
        ...
        j.setReducerClass(ReduceForLargestSmallestTransactionInBrazil.class);
        j.setCombinerClass(CombineForLargestSmallestTransactionInBrazil.class);
    ...
    public static class CombineForLargestSmallestTransactionInBrazil extends Reducer<Text, LargestSmallestTransaction, Text, LargestSmallestTransaction> {
    ...
    public static class ReduceForLargestSmallestTransactionInBrazil extends Reducer<Text, LargestSmallestTransaction, Text, Text> {
        public void reduce(Text key, Iterable<LargestSmallestTransaction> values, Context con)
                throws IOException, InterruptedException {
