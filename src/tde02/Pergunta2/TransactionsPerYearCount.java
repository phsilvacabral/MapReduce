...
public class TransactionsPerYearCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path output = new Path("output/pergunta_2");
        ...
        j.setCombinerClass(CombinerForTransactionsPerYearCount.class);
        j.setReducerClass(ReducerForTransactionsPerYearCount.class);
    ...
    public static class CombinerForTransactionsPerYearCount extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static class ReducerForTransactionsPerYearCount extends Reducer<Text, IntWritable, Text, IntWritable> {
